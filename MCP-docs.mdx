...
- **An MCP server (HTTP stream)** that can directly query this documentation, ensuring your coding assistant receives real-time information about available commands and features.
...
```bash
claude mcp add --transport http blaxel-docs [https://docs.blaxel.ai/mcp](https://docs.blaxel.ai/mcp)
```
