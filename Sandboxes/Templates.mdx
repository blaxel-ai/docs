...
<Note>
  Variables defined here are baked into the image. Variables can also be [updated on a running sandbox](/Sandboxes/Variables-and-secrets#update-variables-on-an-existing-sandbox), or given a new value when you [fork a sandbox](/Sandboxes/Fork#fork-with-new-environment-variables). See the [variables and secrets](/Sandboxes/Variables-and-secrets) documentation for details.
</Note>
