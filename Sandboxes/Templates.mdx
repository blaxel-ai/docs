...
6. Click **Share** to confirm.
    ...
    ![Share between workspaces](/images/sandboxes/share-account.webp)
...
<Note>
  Cross-account image sharing is not currently supported in the Management API. Use the Blaxel Console instead.
</Note>
