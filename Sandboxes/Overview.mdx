...
The project directory contains the Blaxel configuration file `blaxel.toml`, which can be further customized to suit your sandbox deployment requirements. [Learn more about the `blaxel.toml` file](/deployment-reference).
