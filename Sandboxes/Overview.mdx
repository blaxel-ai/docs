...
<iframe style="border:0;" width="800" height="450" src="[https://www.tella.tv/video/cma91vg3d00020bkydp5491db/embed?b=0&title=0&a=1&loop=0&t=0&muted=0&wt=0](https://www.tella.tv/video/cma91vg3d00020bkydp5491db/embed?b=0&title=0&a=1&loop=0&t=0&muted=0&wt=0)" allowfullscreen allowtransparency></iframe>
...
- the image to use. The list of public images [can be found here](https://github.com/beamlit/sandbox/tree/main/hub). To create a sandbox with one of those images, enter `blaxel/prod-{NAME}:latest` (e.g. `blaxel/prod-base:latest`).
- the ports to expose
