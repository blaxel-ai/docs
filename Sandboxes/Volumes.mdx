...
<Tip>
  For temporary scratch space that is destroyed with the sandbox, use [ephemeral volumes](/Volumes/Ephemeral-volumes) instead. You can attach several of them alongside a persistent volume.
</Tip>
