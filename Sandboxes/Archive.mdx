...
<Note>
  On mk3.0 infrastructure, pass `"imageDevice": "/dev/ukp_rom0"`. The default, `/dev/vda`, is where mk3.1 exposes the image the sandbox booted from.
</Note>
