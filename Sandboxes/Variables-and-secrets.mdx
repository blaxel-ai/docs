...
<Note>
  On the new sandbox generation, you can update environment variables on a running sandbox, or give them a new value when you [fork a sandbox](/Sandboxes/Fork#fork-with-new-environment-variables). Both are in preview. Other parts of the runtime spec, such as memory, cannot be changed on a running sandbox.
</Note>
