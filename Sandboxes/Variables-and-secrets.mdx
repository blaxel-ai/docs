...
<Note>
  Environment variables can be updated on a running sandbox, or given a new value when you [fork a sandbox](/Sandboxes/Fork#fork-with-new-environment-variables). Other parts of the runtime spec, such as memory, cannot be changed on a running sandbox.
</Note>
