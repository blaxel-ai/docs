...
For the Agent Drives preview, a [custom sandbox template](/Sandboxes/Templates#create-a-sandbox-template) is required. Run:
...
To ensure compatibility with the Agent Drives preview, update the following line in the `Dockerfile`.
...
Your sandbox will now be ready to use with the Agent Drives preview.
