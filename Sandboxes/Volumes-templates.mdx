...
title: 'Volumes templates 🆕'

description: 'Pre-populate volumes with files for faster environment setup.'

---

<Warning>Blaxel Volumes and Volumes Templates are currently in private preview. Please [contact us](https://blaxel.ai/contact?message=I+would+like+to+get+access+to+volumes+because+&purpose=volumes&origin=docs) if you would like to get access before the public release date.</Warning>
...
```bash
bl new volumetemplate mytemplate
```
