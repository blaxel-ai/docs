...
title: 'Sandbox file system: read, write, and manage files'

description: 'Read, write, list, and delete files inside a Blaxel sandbox using a simple file system interface from the SDK, MCP server, or REST API.'
