...
The sandbox metadata includes a read-only parameter, `expires_in`, that specifies the exact date and time when a sandbox will terminate due to its TTL or lifecycle policy.
