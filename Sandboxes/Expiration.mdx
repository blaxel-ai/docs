...
The sandbox metadata includes a read-only parameter, `expires_in`, that computes the number of seconds until a sandbox is terminated due to its TTL or lifecycle policy.
