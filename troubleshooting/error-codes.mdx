---
title: "Blaxel API error codes and troubleshooting reference"
description: "Reference for structured error codes returned by Blaxel API responses, including the JSON body format and headers designed for LLMs and coding agents."
---
