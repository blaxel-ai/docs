...
To get started with Beamlit CLI, your must first create a [workspace](../Security/Workspace-access-control) on the Beamlit console. Then, login to Beamlit using the following command and replacing `your-workspace`:
