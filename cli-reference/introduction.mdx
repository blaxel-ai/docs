...
To get started with Blaxel CLI, your must first create a [workspace](../Security/Workspace-access-control) on the Blaxel console. Then, login to Blaxel using the following command and replacing `your-workspace` with your workspace’s slug:
