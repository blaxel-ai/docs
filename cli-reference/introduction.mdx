...
| BIN_DIR=$HOME/.local/bin sudo -E sh
...
| VERSION=0.16.0 BIN_DIR=$HOME/.local/bin sh
...
| BIN_DIR=/usr/local/bin sudo -E sh
...
- [beamlit apply](https://www.notion.so/beamlit_apply) - Apply a configuration to a resource by file
- [beamlit completion](https://www.notion.so/beamlit_completion) - Generate the autocompletion script for the specified shell
- [beamlit delete](https://www.notion.so/beamlit_delete) - Delete a resource
- [beamlit get](https://www.notion.so/beamlit_get) - Get a resource
- [beamlit login](https://www.notion.so/beamlit_login) - Log in to Beamlit
- [beamlit logout](https://www.notion.so/beamlit_logout) - Log out from Beamlit
- [beamlit metrics](https://www.notion.so/beamlit_metrics) - Get metrics for a model deployment
- [beamlit run](https://www.notion.so/beamlit_run) - Run an inference
- [beamlit workspaces](https://www.notion.so/beamlit_workspaces) - List all workspaces with the current workspace highlighted. Optionally set a new current workspace