...
To get started with Blaxel CLI, your must first create a [workspace](../Security/Workspace-access-control) on the Blaxel console. Then, login to Blaxel using this command. Find your **workspace ID in the top left corner** of Blaxel Console:
