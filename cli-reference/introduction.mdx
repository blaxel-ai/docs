...
<Warning>
If you set `DO_NOT_TRACK=true` in your environment but have `tracking: false` in your config file, tracking will be enabled because the environment variable takes precedence.
</Warning>
