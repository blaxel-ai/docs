...
POST https://run.blaxel.ai/{YOUR-WORKSPACE}/models/{YOUR-MODELAPI}
...
It is necessary to authenticate all inference requests, via a [bearer token](../Security/Access-tokens%2013847e47b1ea813cac82ed531bd2356f). The evaluation of authentication/authorization for inference requests is managed by the Global Agentics Network based on the [access given in your workspace](../Security/Workspace-access-control).
