...
description: 'Make inference requests to model APIs via their global endpoints on the Global Agentics Network, with ChatCompletions and custom sub-endpoint support.'
...
- calling `run.blaxel.ai/your-workspace/models/your-model/v1/chat/completions` (the ChatCompletions API implementation) will generate a response based on a list of messages
...
![workbench.webp](/Models/Query-a-model/workbench.webp)