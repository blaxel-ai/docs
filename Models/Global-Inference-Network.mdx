...
- **Mode 1: Fully managed Beamlit deployment.** Directly deploy a model on Beamlit to make it available on the Global Inference Network. Consumers have a fully serverless endpoint to access the models. Read [our guide on how to deploy models on Beamlit](Model-deployment).
...
- [Environments](../Model-Governance/Environments) allow you to manage a development/production life-cycle on Beamlit
- [Deployment policies](../Model-Governance/Policies) allow you to enforce rules and strategies for your entire organization regarding the deployment of models, such as allowed or restricted locations, hardware, or routing and failover strategies.
- Set up fine-grained authentication and authorization through [Beamlit IAM](../Security/Workspace-access-control), and evaluate inference permissions at edge in the Global Inference Network
- Centralize [inference logs and metrics](../Observability/View-model-logs) for AI workloads deployed across multiple locations
...
Read [our guide about how to set up deployment policies](../Model-Governance/Policies).