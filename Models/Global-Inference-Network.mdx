...
The *Global Agentics Network* makes up the entire backbone of Blaxel. It is a globally distributed infrastructure, on which ML teams can push serverless AI agents across multiple clusters and locations.
...
The Global Agentics Network is a **very flexible and configurable infrastructure** built for IT and ML teams. Both the execution plane and data plane can be configured and managed through other services of the Blaxel platform, [as detailed below](Global-Inference-Network).
...
- **Mode 1: Fully managed Blaxel deployment.** Directly deploy an agent on Blaxel to make it available on the Global Agentics Network. Consumers have a fully serverless endpoint to access the agents. Read [our guide on how to deploy agents on Blaxel](../Agents).
