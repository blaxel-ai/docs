...
You can also attach a custom domain and split traffic at fork time:
...
const result = await sandbox.fork("my-app", {
  ...
  traffic: 20,             // send 20% of traffic to this revision (canary)
