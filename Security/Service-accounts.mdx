...
An example of service account is the one used by the [Beamlit operator](../Models/Cloud-Burst-Network/Install-Beamlit-operator) which you can install in your Kubernetes cluster and that can deploy models on Beamlit based on conditions.
