...
An example of service account is the one used by the [Beamlit operator](https://www.notion.so/13847e47b1ea81dab2eefb5694f621ef?pvs=21) which you can install in your Kubernetes cluster and that can deploy models on Beamlit based on conditions.
