...
Service accounts use [API keys](Access-tokens.md) to authenticate on Beamlit. These API keys can be created and managed by admins from the service account’s page, in your workspace settings.

API keys have an expiration date set when they are created. 
