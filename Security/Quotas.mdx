...
Higher tiers have access to additional features, such as higher numbers of standby/concurrent sandboxes, more concurrent jobs, higher sandbox and volume sizes, longer sandbox TTLs, custom domains, and more.
