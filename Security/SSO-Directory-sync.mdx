...
<Note>
  Both features require the **SAML** feature flag on your account. Contact [support@blaxel.ai](mailto:support@blaxel.ai) to enable it.
</Note>
...
- At least one **verified domain** — complete [Domain Policies](/Security/Domain-policies) first
...
<Steps>
  ...
  <Step title="Verify a domain">
    If you haven't already, add and verify your company domain. See [Domain Policies](/Security/Domain-policies).
  </Step>
  <Step title="Open the SSO configuration portal">
    Scroll to **SAML Identity Provider** and click **Configure SAML Provider**.

    ![SAML Identity Provider section](/images/identity-access/saml-provider.png)

    This opens the WorkOS Admin Portal in a new tab.
  </Step>
  <Step title="Configure your identity provider">
    In the WorkOS portal, follow the step-by-step instructions for your IdP. WorkOS provides setup guides for all major providers including Okta, Azure AD, Google Workspace, and OneLogin.

    You'll need to:
    1. Create a new SAML application in your IdP
    2. Copy the **ACS URL** and **Entity ID** from WorkOS into your IdP
    3. Copy the **IdP SSO URL** and **X.509 certificate** from your IdP back into WorkOS
  </Step>
...
<Steps>
  ...
  <Step title="Open the Directory Sync portal">
    ...
    ![Directory Sync section](/images/identity-access/directory-sync.png)

    This opens the WorkOS Admin Portal in a new tab.
  </Step>
  <Step title="Connect your directory">
    In the WorkOS portal, select your directory provider and follow the setup instructions. WorkOS supports Okta SCIM, Azure AD SCIM, Google Directory, and more.
  </Step>
...
![Team members table with Source column](/images/identity-access/team-source-column.png)
...
<Warning>
  Avoid manually removing members who were provisioned by Directory Sync — they will be re-added on the next sync. Manage membership through your identity provider instead.
</Warning>
...
- [Domain Policies](/Security/Domain-policies)
