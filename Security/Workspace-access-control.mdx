...
Users can be either [team members](Workspace-access-control.md), or [service accounts](Service-accounts.md) that represent external systems that can operate Beamlit (typically, a [Beamlit operator](../Models/Cloud-Burst-Network/Install-Beamlit-operator.md)). They are added to a workspace with certain permissions on the workspace resources inherited from their role.
...
- [models](../Models/Model-deployment.md) (including [querying](../Models/Query-a-model.md) them)
- [model deployments](../Models/Model-deployment.md)
