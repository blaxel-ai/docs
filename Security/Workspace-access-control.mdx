...
Users can be either [team members](Workspace-access-control%2013847e47b1ea8151bd43efeccf5defe0), or [service accounts](Service-accounts) that represent external systems that can operate Beamlit (typically, a [Beamlit operator](https://www.notion.so/Install-Beamlit-operator-13847e47b1ea81dab2eefb5694f621ef?pvs=21)). They are added to a workspace with certain permissions on the workspace resources inherited from their role.
