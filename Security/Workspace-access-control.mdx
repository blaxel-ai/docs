...
All resources on Blaxel are logically regrouped in a **workspace**, which is the highest possible level of tenancy. An account can have **multiple workspaces** — a common pattern when dealing with multiple environments (e.g. development vs. production), business units, or end-clients.
...
- Subscription tier and quota limits
- Credits
