...
description: "Verify your company's email domain on Blaxel to control which login methods your team can use and automatically onboard new users to workspaces."
---
...
<Steps>
  <Step title="Open Identity & Access settings">
    ...
    ![Identity & Access settings page](/images/identity-access/identity-access-page.webp)
  </Step>
...
<Steps>
  <Step title="Reveal the DNS record">
    ...
    ![DNS TXT record panel](/images/identity-access/dns-verification.webp)
  </Step>
...
![Verified domain with allowed auth methods and auto-join](/images/identity-access/domain-verified.webp)
...
Multi-factor authentication (MFA) is available for all login methods except SAML/SSO. Users can enroll a TOTP authenticator app or an SMS factor from their account settings and will be prompted for the second factor at each login. MFA is not available when SAML SSO is active, since identity verification is handled by your identity provider.
