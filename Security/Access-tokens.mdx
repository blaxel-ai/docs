...
User access tokens can be used in order to authenticate to Blaxel by API or CLI. They apply for both [users](Workspace-access-control%2013847e47b1ea8151bd43efeccf5defe0) and [service accounts](Service-accounts). They are generated through a variety of methods, which are documented below.
