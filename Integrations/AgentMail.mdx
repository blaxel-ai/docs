...
title: 'AgentMail'
description: 'Use AgentMail with Blaxel to build an intelligent assistant that autonomously answers technical questions over email through agentic inboxes.'
---
...
![inbox.webp](/Integrations/AgentMail/inbox.webp)

From the same dashboard, obtain an API key:

![api.webp](/Integrations/AgentMail/api.webp)
...
![deployment.webp](/Integrations/AgentMail/deployment.webp)
