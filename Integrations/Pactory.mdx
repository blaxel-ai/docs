...
First, [deploy an agent](../Agents/Deploy-an-agent%2018c47e47b1ea80658f94d9c463f5b493) on Blaxel (formerly Beamlit). Once the agent is deployed, retrieve its [inference endpoint](../Agents/Query-agents).
