...
title: 'Rippletide'
description: 'Combine Rippletide guardrails with Blaxel sandboxes to enforce agent safety, prevent hallucinations, and run trusted agent code securely.'
...
> **About this example:** This page describes the original Python customer-support example. For the current Rippletide connection workflow, start with the [official Quickstart](https://docs.rippletide.com/docs/quickstart). That CLI setup supports JavaScript and TypeScript agents and MCP servers. It is not a drop-in replacement for this Python example.
...
<Card title="Rippletide Documentation" icon="book" href="https://docs.rippletide.com/">
