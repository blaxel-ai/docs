...
The Azure AI Foundry integration allows Beamlit users to **call models deployments from [Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-studio/what-is-ai-studio) services** (Azure AI Inference, Azure OpenAI Service, and Azure AI Services) through a Beamlit endpoint that unifies access control, credentials and observability management. 
