...
description: 'Set up the Mistral AI integration on Blaxel to call Mistral models through a unified endpoint with centralized access control and observability.'
...
![image.webp](/Integrations/MistralAI/image.webp)

## Connect to a Mistral AI model
