...
description: 'Deploy public or private AI models from Hugging Face on Blaxel and serve them as auto-scalable inference endpoints for your agents.'
...
![hf-integration.webp](/Integrations/HuggingFace/hf-integration.webp)
...
![image.webp](/Integrations/HuggingFace/image.webp)
...
If the model you're trying to connect to is [gated](https://huggingface.co/docs/hub/models-gated), you'll **first need to request access on HuggingFace,** and accept their terms and conditions of usage (if applicable). Access to some HuggingFace models is granted immediately after request, while others require manual approval.
...
![image.webp](/Integrations/HuggingFace/image1.webp)
