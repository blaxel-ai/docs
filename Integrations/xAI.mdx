...
In order to use this integration, you must register an xAI access token into your Beamlit workspace settings. First, generate an [xAI API key](https://docs.x.ai/docs/quickstart#creating-an-api-key) from [your xAI team console](https://console.x.ai/). 
