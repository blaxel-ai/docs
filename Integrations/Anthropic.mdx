...
description: 'Set up the Anthropic integration on Blaxel to call Claude models through a unified endpoint with centralized access control and observability.'
...
![image.webp](/Integrations/Anthropic/image.webp)
...
![image.webp](/Integrations/Anthropic/image%201.webp)
