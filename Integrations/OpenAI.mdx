...
description: 'Set up the OpenAI integration on Blaxel to call OpenAI models through a unified endpoint with centralized access control and observability.'
...
<Info>
  To connect an OpenAI-hosted agent to a Blaxel Sandbox, see [OpenAI Agents API](/Integrations/OpenAI-Agents-API). This page covers OpenAI model access through Model Gateway.
</Info>
...
![Screenshot 2024-12-06 at 10.41.25 AM.webp](/Integrations/OpenAI/Screenshot_2024-12-06_at_10.41.25_AM.webp)
...
![Screenshot 2024-12-06 at 10.46.23 AM.webp](/Integrations/OpenAI/Screenshot_2024-12-06_at_10.46.23_AM.webp)
