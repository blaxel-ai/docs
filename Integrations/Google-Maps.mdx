...
description: 'Connect the Google Maps API to your Blaxel agents to enable geocoding, directions, place search, and other location-based capabilities.'

---

The *Google Maps integration* lets you equip your agents with tools to interact with Google Maps services, enabling location-based functionalities and geographic data processing within your applications.
...
![image.webp](/Integrations/Google-Maps/image.webp)
