...
![image.webp](/Integrations/Gmail/image.webp)

### Multi-tenant

Follow [this guide](/Integrations/oauth-flow) to learn how to automate the creation of dedicated Gmail integrations through a user-facing OAuth flow.
