...
MCP servers deployed on Blaxel are only hosted server-side and cannot be installed locally. Only WebSockets protocol is supported.
...
<Card title="Implement semantic tool search" icon="screwdriver-wrench" href="/Functions/Integrate-in-apps/Toolprint">
This example highlights how to use Toolprint for semantic tool selection to enable effective function calling even with a high number of tools.
</Card>