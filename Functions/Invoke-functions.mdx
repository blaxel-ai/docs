...
<Note>
You must provide your [Blaxel API key](../Security/Access-tokens) in the `Authorization` header. If your user has access to multiple workspaces, include the workspace header as well.
