...
Blaxel is a **serverless platform** that gives AI Builders the dev tools and infrastructure to build and deploy **AI agents**. Blaxel lets you bring your own model APIs, MCP servers and agents code (in Python or TypeScript) and runs them securely with low-latency and high-availability.
...
Blaxel provides developer tools for running such production-grade multi-agents that can use tools, LLMs and code sandboxes ; and offers infrastructure to run these agents on a global network that makes them **resilient** and ensures **secure interactions with your private systems**, wherever they are.
...
Blaxel exposes some APIs of the core infrastructure to give full flexibility to AI builders over management of deployment locations, lifecycle, and resource allocation — for example with [sandboxed VMs](Sandboxes/Overview).
...
- **Product Documentation**
    ...
    - [MCP servers](Functions/Overview): Expose capabilities and execute tool calls for your AI agents
