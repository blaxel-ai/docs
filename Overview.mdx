...
Blaxel exposes some APIs of the core infrastructure to give full flexibility to AI builders over management of deployment locations, lifecycle, and resource allocation — for example with [sandbox VMs](UVM/Overview).
