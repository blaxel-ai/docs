...
title: 'Blaxel documentation: build and run AI agents at scale'

description: 'Blaxel documentation home. Learn how to build, host, and scale AI agents with perpetual sandboxes, serverless hosting, MCP servers, jobs, and model APIs.'
