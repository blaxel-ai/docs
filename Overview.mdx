...
title: 'Blaxel overview: perpetual sandboxes and agent hosting'

description: 'Introduction to Blaxel core building blocks: perpetual sandboxes, serverless Agents Hosting, MCP servers, batch jobs, model APIs, Volumes, and Agent Drive.'
