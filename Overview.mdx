...
description: 'Welcome to Blaxel: a perpetual sandbox platform for AI agent builders, with serverless agent hosting, hosted MCP servers, batch jobs, and model APIs.'
