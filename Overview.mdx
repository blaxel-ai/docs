...
description: 'Blaxel is a perpetual sandbox platform for AI agents, with serverless hosting for agents, MCP servers, batch jobs, and model APIs on global infrastructure.'
