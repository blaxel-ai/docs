...
Blaxel exposes some APIs of the core infrastructure to give full flexibility to AI builders over management of deployment locations, lifecycle, and resource allocation — for example with [agentic VMs](UVM/Overview).
...
- **Product Documentation**
    ...
    - [Sandbox VMs](UVM/Overview): Equip your agents with blazing-fast virtual machines to manage files, run commands and code
