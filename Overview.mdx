...
title: 'Blaxel documentation home for AI agent builders'

description: 'Start here to build on Blaxel: sandboxes for LLM code execution, serverless agent hosting, MCP servers, batch jobs, and unified model APIs.'
