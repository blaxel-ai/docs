...
title: 'Blaxel platform overview for AI agent builders'

description: 'Overview of the Blaxel platform: perpetual sandboxes, serverless agent hosting, hosted MCP servers, batch jobs, model APIs, and the Global Agentics Network.'
