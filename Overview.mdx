...
title: 'Blaxel platform overview: build and run AI agents at scale'

description: 'Overview of the Blaxel platform for AI agents, covering perpetual sandboxes, serverless agent hosting, MCP tool servers, batch jobs, and model APIs.'
