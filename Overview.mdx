...
title: 'Blaxel platform overview: sandboxes, agents, and MCP'

description: 'Learn how Blaxel powers AI agents with perpetual sandboxes, Agents Hosting, MCP servers, batch jobs, and a model gateway on a global low-latency network.'
