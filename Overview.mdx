...
title: 'Blaxel docs: build and deploy AI agents'

description: 'Start here for the Blaxel documentation: standby sandboxes, serverless agent hosting, hosted MCP servers, batch jobs, model APIs, and SDKs.'
