...
description: 'Overview of the Blaxel platform for AI agent builders: standby sandboxes, serverless agent hosting, hosted MCP servers, batch jobs, and model APIs.'
