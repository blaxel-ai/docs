...
description: 'Welcome to Blaxel: the perpetual sandbox cloud for AI agents, with standby microVMs, serverless hosting, MCP servers, batch jobs, and a model gateway.'
