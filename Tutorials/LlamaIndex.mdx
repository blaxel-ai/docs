---
title: "Run LlamaIndex on Blaxel"
description: "Deploy LlamaIndex agent and RAG projects to Blaxel with minimal code changes to get serverless hosting, agentic observability, and governance."
---
...
- else initialize an example project in LlamaIndex by using the following Blaxel CLI command and selecting the _LlamaIndex hello world:_
