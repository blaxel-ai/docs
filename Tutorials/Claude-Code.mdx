...
<Note>
  If you wish to use an Anthropic API key instead of logging in to your Claude or Anthropic Console account, refer to the [alternative steps for API key recognition in Claude Code](https://github.com/anthropics/claude-code/issues/441).
</Note>
