---
title: "Run AI SDK on Blaxel"
description: "Deploy Vercel AI SDK agent projects to Blaxel with minimal code changes to get serverless hosting, agentic observability, and governance policies."
---
...
- else initialize an example project with AI SDK by using the following Blaxel CLI command and selecting the _Vercel AI hello world:_
