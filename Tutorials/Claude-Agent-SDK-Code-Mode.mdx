...
This tutorial creates and deploys an MCP server for the example [Petstore v2 API](https://petstore.swagger.io/). For authorization purposes, the API maintainers offer a sample key (`special-key`) for test purposes.
      ...
      spec: {
        runtime: {
          ...
          envs: [
            ...
            { name: "AUTH_API_KEY", value: "special-key" },
          ],
        },
      },
    },
