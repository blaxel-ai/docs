---
title: "Use Claude Agent SDK with MCP Code Mode"
description: "Connect the Claude Agent SDK to a Blaxel MCP server running in code mode to call any OpenAPI-described API by executing TypeScript in a sandbox."
---
