...
This tutorial creates and deploys an MCP server for the example [Petstore API](https://petstore.swagger.io/). This API requires [authentication](../Functions/Code-mode#authentication), but the maintainers provide the authentication key `special-key` for testing purposes.
