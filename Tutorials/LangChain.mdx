---
title: "Run LangChain on Blaxel"
description: "Deploy LangChain and LangGraph projects to Blaxel with minimal code changes to get serverless hosting, agentic observability, and policies."
---
...
- or initialize an example project in LangChain by using the following Blaxel CLI command and selecting the _LangChain hello world:_
