...
<img className="block dark:hidden" src="/img/herdr/tool-chooser.webp" alt="Herdr tool chooser offering Codex, Claude Code, OpenCode, and Pi over a dimmed dashboard" />
<img className="hidden dark:block" src="/img/herdr/tool-chooser.webp" alt="Herdr tool chooser offering Codex, Claude Code, OpenCode, and Pi over a dimmed dashboard" />
...
<img className="block dark:hidden" src="/img/herdr/dashboard.webp" alt="Herdr dashboard showing a running Pi sandbox and Connect, Apply, Previews, Stop, and Delete controls" />
<img className="hidden dark:block" src="/img/herdr/dashboard.webp" alt="Herdr dashboard showing a running Pi sandbox and Connect, Apply, Previews, Stop, and Delete controls" />
...
<img className="block dark:hidden" src="/img/herdr/apply-changes.webp" alt="Herdr displaying a checked patch with colored additions and deletions before local Apply approval" />
<img className="hidden dark:block" src="/img/herdr/apply-changes.webp" alt="Herdr displaying a checked patch with colored additions and deletions before local Apply approval" />
