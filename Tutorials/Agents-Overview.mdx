---
title: "Agent framework tutorials overview"
description: "Browse framework-specific tutorials for shipping AI agents on Blaxel using LangChain, CrewAI, LlamaIndex, ADK, AI SDK, PydanticAI, and more."
---
...
<CardGroup cols={2}>
  <Card title="Herdr" href="/Tutorials/Herdr">
    Run coding agents in persistent Blaxel sandboxes and apply reviewed changes to your local worktree.
  </Card>

  <Card title="DeepSeek Harness" href="/Tutorials/DeepSeek-Harness">
    Move DeepSeek Harness sessions into Blaxel sandboxes and return reviewed changes to your local repository.
  </Card>
  ...
  <Card title="Claude Managed Agents" icon="server" href="/Tutorials/Claude-Managed-Agents">
