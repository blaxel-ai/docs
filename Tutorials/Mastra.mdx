---
title: "Run Mastra on Blaxel"
description: "Deploy Mastra TypeScript agent projects on Blaxel with serverless hosting, observability, and connections to MCP servers and LLM APIs."
---
...
- else initialize an example project in Mastra by using the following Blaxel CLI command and selecting the _Mastra hello world:_
