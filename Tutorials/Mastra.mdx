...
description: "Build Mastra TypeScript agents with built-in support for Blaxel sandboxes, giving your agents secure remote execution environments in the cloud."
---
...
More information on Mastra installation is available in the [Mastra documentation](https://mastra.ai/docs/getting-started/manual-install).
