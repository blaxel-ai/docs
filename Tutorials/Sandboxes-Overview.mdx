---
title: "Sandbox application tutorials overview"
description: "Browse tutorials for running web applications like Astro, Next.js, Expo, code-server, Docker, and Tailscale inside Blaxel sandboxes."
---
