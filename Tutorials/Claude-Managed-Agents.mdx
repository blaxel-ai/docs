...
<Card title="Connect to a sandbox from Claude Agent SDK" icon="thumbs-up" href="./Claude-Agent-SDK-MCP">
  Operate a remote Blaxel sandbox from your Claude Agent SDK (using MCP).
</Card>

<Card title="Run Claude Code in a sandbox" icon="thumbs-up" href="./Claude-Code">
