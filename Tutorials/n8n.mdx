---
title: "Orchestrate Blaxel agents with n8n"
description: "Build n8n workflows that forward chat messages to Blaxel-hosted AI agents via HTTP requests, with step-by-step setup and configuration."
---
...
![image.webp](/img/tutorials/n8n/image.webp)
...
![image.webp](/img/tutorials/n8n/image1.webp)
...
1. **Set up the header auth credentials:**
   Ensure that your HTTP Request node is set in **_Header Auth_** type.
   ![image.webp](/img/tutorials/n8n/image2.webp)
2. **Create Credentials:**
   ...
   ![image.webp](/img/tutorials/n8n/image3.webp)
