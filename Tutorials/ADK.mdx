---
title: "Run Google ADK on Blaxel"
description: "Deploy Google Agent Development Kit (ADK) projects to Blaxel with minimal code changes to get serverless hosting, observability, and policies."
---
...
- if you already have an ADK agent, adapt your code with [Blaxel SDK commands](../Agents/Develop-an-agent) to connect to [MCP servers](../Functions/Overview), [LLMs](../Models/Overview) and [other agents](../Agents/Overview).
- else initialize an example project with ADK by using the following Blaxel CLI command and selecting the _Google ADK hello world:_
...
## Develop an ADK agent using Blaxel features
...
Or [connect a GitHub repository to Blaxel](../Agents/Github-integration) for automatic deployments every time you push on _main_.