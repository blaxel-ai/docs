...
This tutorial uses the [Blaxel OpenAI Agents API cookbook](https://github.com/blaxel-ai/openai-agents-api-cookbook) to demonstrate that lifecycle with a small report.
...
Start with [main.py](https://github.com/blaxel-ai/openai-agents-api-cookbook/blob/main/main.py) for one session. Use [handoff.py](https://github.com/blaxel-ai/openai-agents-api-cookbook/blob/main/handoff.py) when your workflow needs a fresh agent to continue from a persisted artifact.
...
<Card title="OpenAI Agents API cookbook" icon="github" href="https://github.com/blaxel-ai/openai-agents-api-cookbook">
