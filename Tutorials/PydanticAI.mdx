---
title: "Run PydanticAI on Blaxel"
description: "Deploy PydanticAI agent projects to Blaxel with minimal code changes to get serverless hosting, agentic observability, and governance policies."
---
...
- else initialize an example project in PydanticAI by using the following Blaxel CLI command and selecting the _PydanticAI hello world:_
