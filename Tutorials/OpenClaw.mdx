...
Blaxel's agent template uses autoscaling to keep at least OpenClaw instance running at all times. Autoscaling is only available on Tier 2 and higher plans.
