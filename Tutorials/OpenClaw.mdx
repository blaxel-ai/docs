...
The template includes a 4 GB persistent volume mounted at `/root/.openclaw`. This volume preserves OpenClaw's data (conversation history, configuration, and agent state) across restarts and redeployments.
