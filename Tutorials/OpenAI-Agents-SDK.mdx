---
title: "Use OpenAI Agents SDK with sandboxes"
description: "Use the OpenAI Agents SDK to create compute-capable Codex agents backed by Blaxel sandboxes for running commands, editing files, and executing code."
sidebarTitle: "Example: Connect from OpenAI Agents SDK"
---
