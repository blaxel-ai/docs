...
### Adjusted exception data collection defaults in SDKs to require explicit opt-in

Exception data collection in the Python SDK (v0.2.46+), TypeScript SDK (v0.2.76+) and Go SDK (0.16.1+) is now disabled by default. Users must now explicitly opt-in.
