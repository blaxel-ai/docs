...
<Frame>
<img src="/images/changelog/2026/console-sidebar.png" />
</Frame>
</Update>
...
Added new read-only parameter, `expires_in`, to sandbox metadata that computes the number of seconds until a sandbox is terminated due to its TTL or lifecycle policy.
