...
- Added new read-only parameter, `expires_in`, to sandbox metadata that specifies the exact date and time when a sandbox will terminate due to its TTL or lifecycle policy.
