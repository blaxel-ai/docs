...
- Added support for storing the last 10 revisions for agents, MCPs, models and batch jobs. Revisions are deployed using the blue-green deployment strategy. This enables rollbacks and progressive rollout strategies (e.g. canary deployments).
