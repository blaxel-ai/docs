...
### TanStack AI cookbook

Build apps with TanStack AI and Claude Code inside Blaxel sandboxes. The [cookbook](https://github.com/blaxel-ai/blaxel-tanstack-ai-cookbook) includes a private local playground, model and thinking controls, and a model/tool example. Follow the [tutorial](/Tutorials/TanStack-AI).
