...
Blaxel is now [integrated with Stripe Projects](https://blaxel.ai/blog/stripe-projects-blaxel-integration). Use existing Stripe payment methods to provision Blaxel sandboxes and drives directly from the Stripe Projects CLI.
