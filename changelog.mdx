...
Sandbox process execution logs can now be viewed from your browser in the Blaxel Console. This makes it easier to inspect command output, troubleshoot errors, and monitor running processes.
