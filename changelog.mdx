---
title: 'Blaxel platform changelog and release notes'
description: 'Chronological log of all Blaxel platform updates, new feature releases, deprecations, infrastructure changes, and notable improvements.'
---
...
### Network-level domain filter enforcement

Sandboxes can now enforce [domain filtering](/Sandboxes/Proxy-domains#domain-filter-enforcement) at the network level with `network.firewall: { rulesets: ["proxy"] }`, so traffic from tools that ignore `HTTP_PROXY`/`HTTPS_PROXY` is still filtered. Available on Mark 3.0 infrastructure.
...
The [OpenAI Agents API integration reference](/Integrations/OpenAI-Agents-API) covers running OpenAI-hosted agents in Blaxel Sandboxes, keeping files on Agent Drive, and reconnecting workers through a webhook handler. It includes credentials, shared files for agent teams, lifecycle rules, configuration, and cleanup. The cookbook currently requires Agents API preview access.

Follow the [tutorial](/Tutorials/OpenAI-Agents-API) to run the public cookbook, hand files to a fresh agent, coordinate parallel specialists, and verify a replacement worker reads the previous worker's files.

</Update>

<Update label="2026-09-08">

### Herdr sandbox tutorial

The [Herdr tutorial](/Tutorials/Herdr) walks through running a coding agent in a persistent Blaxel sandbox, reconnecting to its session, opening a private application preview, and applying reviewed changes to a local Git worktree. It includes an invoice summary example and static screenshots of the dashboard and apply workflow.

</Update>

<Update label="2026-09-04">

### Snapshots as workspace resources

[Snapshots](/Sandboxes/Fork) have their own name and API at workspace level. A snapshot outlives the sandbox it was captured from, and carries the configuration needed to fork it into a new sandbox or application once its source is gone.

</Update>

<Update label="2026-09-02">

### DeepSeek Harness sandbox plugin

[`@blaxel/dsh-sandbox`](https://github.com/blaxel-ai/deepseek-harness-blaxel-sandbox) runs DeepSeek Harness filesystem, Bash, and terminal tools inside a Blaxel sandbox while the DSH interface, model requests, and credentials stay on your computer. Move a session to Blaxel and back with a conflict-checked return. See the [tutorial](/Tutorials/DeepSeek-Harness).

</Update>

<Update label="2026-08-14">

### Method and path matching for sandbox egress rules

[Sandbox domain filtering](/Sandboxes/Proxy-domains#method-and-path-patterns) now supports HTTP method, path prefix, wildcard, and negation patterns, letting you restrict outbound access beyond domain-level allowlists and denylists.

</Update>

<Update label="2026-08-13">

### Dynamic value injection in the sandbox proxy

Proxy routing rules can now [generate UUIDs, timestamps, nonces, and other dynamic values](/Sandboxes/Proxy-secrets-injection#dynamic-value-injection) for every request. Inject them into headers and body fields for idempotency keys, request IDs, and other one-time values.

</Update>

<Update label="2026-07-29">

### S3-compatible access for Agent Drive

Every Agent Drive instance now exposes an [S3-compatible endpoint](/Agent-drive/S3-endpoint), so you can access its contents with the AWS CLI, boto3, or the AWS SDK for JavaScript without mounting the drive into a sandbox.

</Update>

<Update label="2026-07-24">

### Sandbox snapshots and forking

Our biggest update since we launched sandboxes!

In private preview, create point-in-time [snapshots of a sandbox](/Sandboxes/Fork), roll back to an earlier checkpoint, or fork its filesystem, running processes, and memory state into a new sandbox.

### Application Runtime

Introducing Application Runtime in private preview for deploying long-running web servers, APIs, dashboards, and other services on stable public endpoints.

</Update>

<Update label="2026-07-19">

### Agent-led onboarding

Added a new agent-led onboarding experience that helps you set up projects and manage Blaxel resources via your coding agent.

</Update>

<Update label="2026-07-14">

### Share custom domains across workspaces

Verified preview custom domains can now be [shared with another workspace](/Infrastructure/Custom-domains#share-a-custom-domain). Shared domains remain read-only in target workspaces and can be used for their sandbox previews.

</Update>

<Update label="2026-07-13">

### Carbon (a.k.a. Mark 3.1) infrastructure

Introducing [Carbon](/Infrastructure/Gens#carbon-aka-mark-31)! The latest iteration of Blaxel's microVM-based infrastructure, in private preview.

Carbon infrastructure enables long-awaited features such as manual snapshotting, forking, and much more!
...
### Pagination support in Management API

Added [pagination support](/api-reference/introduction#pagination) for list operations in Management API.
...
### External IDs for sandboxes

Added support for user-supplied external identifiers for sandboxes (your session ID, user ID, or application-related ID). Benefit from a fast, indexed lookup without needing to maintain a separate mapping database.
...
<Frame>
<img src="/images/changelog/2026/billing-explorer.webp" alt="New Billing Explorer interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2026/console-sidebar.webp" alt="New Console sidebar navigation" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/cli-login.webp" alt="CLI login manual validation flow" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/new-sidebar.webp" alt="New Console sidebar design" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/blaxel-blog.webp" alt="Blaxel Blog" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/billing-explorer-chart.webp" alt="Billing Explorer chart" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/custom-domains.webp" alt="Custom domains configuration" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/usage-based-pricing.webp" alt="Usage-based pricing model" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/mcp-agentmail.webp" alt="AgentMail and Context7 MCP server integrations" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/cron.webp" alt="Cron jobs scheduling interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/airweave.webp" alt="Airweave MCP server integration" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/supabase.webp" alt="Supabase MCP server integration" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/logs.webp" alt="New Logs console interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/onegrep.webp" alt="OneGrep integration" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/sbx-cold-start.webp" alt="Sandbox cold start performance improvements" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/tavily.webp" alt="Tavily MCP server integration" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/newui.webp" alt="New Blaxel Console interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/adk.webp" alt="Google ADK framework support" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/sdk010.webp" alt="SDK v0.1.0 release" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/mcp-servers-functions.webp" alt="Functions migrated to MCP servers" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/templates-ui.webp" alt="Agent templates interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/revisions.webp" alt="Revisions and canary deployments interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/blaxel.webp" alt="Blaxel rebranding announcement" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/pricing.webp" alt="New pricing plans overview" />
</Frame>

Beamlit officially launched new pricing plans. Learn more about the pricing plans on [our website](https://blaxel.ai/), or log in to the [Beamlit console](https://app.blaxel.ai/main/global-agentic-network) to start your free tier or upgrade.
...
<Frame>
<img src="/images/changelog/2025/deepseek-integration.webp" alt="DeepSeek integration setup" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/hf-integration.webp" alt="HuggingFace integration setup" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/azure-ai-foundry.webp" alt="Azure AI Foundry integration setup" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/mcp-functions.webp" alt="Pre-built MCP server toolkits" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/chart-token.webp" alt="Token usage cost control chart" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/overview-with-map.webp" alt="Blaxel platform overview with global map" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/trace-jan29.webp" alt="Agentic trace visualization" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/chart-latencies.webp" alt="Latency metrics chart" />
</Frame>

A new set of metrics is available for your agents, functions and models: **end-to-end latencies (average, p50, p90, p99)**.
...
<Frame>
<img src="/images/changelog/2025/vscodeextension.webp" alt="Blaxel VS Code extension" />
</Frame>
...
<Frame>
<img src="/images/changelog/2025/newconsole.webp" alt="New Blaxel console interface" />
</Frame>
...
<Frame>
<img src="/images/changelog/2024/metric.webp" alt="Improved chart metrics visualization" />
</Frame>
