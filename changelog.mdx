...
[Snapshots](/Snapshots/Overview) have their own name and API at workspace level. A snapshot outlives the sandbox it was captured from, and carries the configuration needed to fork it into a new sandbox or application once its source is gone.
