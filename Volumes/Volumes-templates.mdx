...
description: 'Create volume templates pre-populated with files, dependencies, or datasets so new Blaxel sandboxes and resources start with environments ready to use.'
