...
<CardGroup cols={2}>
  <Card title="Volume templates with sandboxes" icon="box" href="/Sandboxes/Volumes-templates">
    Create and attach pre-populated volumes to sandboxes.
  </Card>
  <Card title="Volume templates with agents" icon="robot" href="/Agents/Volumes-templates">
