...
To resolve this error, first confirm the workspace name in your request matches a workspace you (or the service account) has access to. Also check your [role in that workspace](/Security/Workspace-access-control) and ask a workspace administrator to grant the required role if it's missing or insufficient.
