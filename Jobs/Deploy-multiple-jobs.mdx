...
title: 'Deploy multiple jobs from a mono-repo'
sidebarTitle: 'Deploy multiple resources'

description: 'Deploy multiple Blaxel batch jobs from a single mono-repo with shared configuration, dependencies, and context to streamline complex workflows.'

---

You can use a **shared context from a single repository** to deploy multiple resources, mixing [batch jobs](Overview), [agents](../Agents/Overview), [MCP servers](../Functions/Overview), etc.
