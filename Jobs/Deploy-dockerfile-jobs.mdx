...
title: 'Deploy jobs with a Dockerfile'
sidebarTitle: 'Deploy with a Dockerfile'

description: 'Ship a Blaxel batch job using your own custom Dockerfile to control the runtime environment, system dependencies, and the entire build process.'
...
# Command to run when container starts, it needs to provide a server running on port 80 for agent and MCP server
