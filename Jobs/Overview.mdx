...
description: 'Run batch processing tasks for AI workflows on Blaxel as scheduled or on-demand jobs that scale automatically and run on serverless infrastructure.'

---

Jobs allow you to run many AI tasks in parallel using batch processing. 

![image.webp](/Jobs/Overview/image.webp)
...
![image.webp](/Jobs/Overview/image1.webp)
