...
title: 'Variables and secrets for jobs'
sidebarTitle: 'Variables and secrets'

description: 'Configure environment variables and secrets for Blaxel batch jobs to securely manage API keys, credentials, and runtime configuration values.'
