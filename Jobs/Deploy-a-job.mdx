...
Read [Ephemeral volumes](/Volumes/Ephemeral-volumes) for configuration details, root filesystem mounts, and limits.

<Note>
  Ephemeral volumes are available for jobs and sandboxes. Agents should use persistent volumes instead.
</Note>
