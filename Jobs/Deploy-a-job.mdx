...
![image](./Overview/job-metrics.png)
...
A private HTTP endpoint for POST requests is always created by default, even if you don’t define any trigger here e.g. `https://api.blaxel.ai/v0/jobs/my-job/executions?workspace=my-workspace`.
