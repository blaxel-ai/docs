...
You can alternatively use `bl push` to build and push the job container image to the Blaxel registry without creating or updating the agent deployment. This is useful for preparing images in advance.
