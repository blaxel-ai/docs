...
You can run a job via the Blaxel API or CLI, or schedule it to run periodically via a cron.

**API**

Start batch job execution by [calling the inference API for your batch job](../api-reference/inference).
