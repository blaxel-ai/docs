---
title: 'Access Agent Drive over S3'
sidebarTitle: 'S3 endpoint'
description: 'Access an Agent Drive instance from S3-compatible clients using its HTTP endpoint, service account credentials, and SigV4 signing.'
tag: "private preview"
---
