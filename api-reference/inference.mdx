...
Whenever you deploy a workload on Blaxel, an **inference endpoint** is generated on Global Inference Network, the [infrastructure powerhouse](../Infrastructure/Global-Inference-Network) that hosts it.
