...
Authentication to the Blaxel APIs can either be done using [API keys](../Security/Access-tokens%2013847e47b1ea813cac82ed531bd2356f) created from the Blaxel console, or through a [classic OAuth 2.0 flow](../Security/Access-tokens).
...
<Card title="Management API" icon="cubes" href="/api-reference/agents/list-agents" > API to manage agents, functions, policies and much more.</Card>