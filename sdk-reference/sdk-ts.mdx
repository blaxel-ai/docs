...
description: 'Install and use the Blaxel TypeScript SDK to programmatically manage sandboxes, agents, MCP servers, jobs, and other resources from Node.js.'

---

Blaxel features an SDK in **TypeScript**.  To install, follow the instructions below.
