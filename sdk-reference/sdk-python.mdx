...
description: 'Install and use the Blaxel Python SDK to programmatically manage sandboxes, agents, MCP servers, jobs, and other workspace resources from Python.'

---

Blaxel features an SDK in **Python**.  To install, follow the instructions below.
