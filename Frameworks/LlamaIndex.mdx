...
You can deploy your [LlamaIndex](https://www.llamaindex.ai/) projects to Blaxel with minimal code edition (and zero configuration), enabling you to use [Serverless Deployments](../Models/Global-Inference-Network%2013847e47b1ea8199a2b3fa9c62f9e09e), [Agentic Observability](https://www.notion.so/Traces-18f47e47b1ea80e29594f9fd7e5a117e?pvs=21), [Policies](../Model-Governance/Policies), and more.

## Get started with LlamaIndex on Blaxel

To get started with LlamaIndex on Blaxel:

- if you already have a LlamaIndex agent, adapt your code with [Blaxel SDK commands](../Agents/Develop-an-agent%2015a47e47b1ea808fa98bdf4f8fde8fce) to connect to [MCP servers](../Functions/Overview%2015347e47b1ea8038813fef14c49dfd5e), [LLMs](../Models/Overview%2015347e47b1ea80f48cbcd345aafd924a) and [other agents](../Agents/Overview).
- initialize an example project in LlamaIndex by using Blaxel CLI command `bl create-agent-app`, select the *LlamaIndex hello world*, and deploy it using `bl deploy`

## Develop a LlamaIndex agent using Blaxel features

While building your agent in LlamaIndex, use Blaxel SDK to connect to resources already hosted on Blaxel:
...
const tools = await blTools(['mcp-server-name']).ToLlamaIndex()
...
const model = await blModel("model-api-name").ToLlamaIndex();
