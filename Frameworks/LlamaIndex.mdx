...
You can deploy your [LlamaIndex](https://www.llamaindex.ai/) projects to Blaxel with minimal code edition (and zero configuration), enabling you to use [Serverless Deployments](../Infrastructure/Global-Inference-Network), [Agentic Observability](../Observability/Overview), [Policies](../Model-Governance/Policies), and more.
