---
title: 'Example: Deploy an agent with Claude Agent SDK'
description: 'Create an agent with Claude Agent SDK and deploy it on Blaxel as a serverless auto-scalable API'
---

[Claude Agent SDK](https://platform.claude.com/docs/en/agent-sdk/overview) is a library for building autonomous AI agents using Claude Code. You can deploy your Claude Agent SDK projects to Blaxel with minimal code editing (and zero configuration), enabling you to use [Serverless Deployments](../Infrastructure/Global-Inference-Network), [Agentic Observability](../Observability/Overview), [Policies](../Model-Governance/Policies), and more.
