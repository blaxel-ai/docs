...
- Models that are deployed on Beamlit, either by [direct deployment](../Models/Model-deployment%2013847e47b1ea8103a274c27cff3de584) or when [overflowing on Beamlit](../Models/Cloud-Burst-Network/Model-overflow%2013847e47b1ea817f82a8c8bda522126f), **automatically export inference logs**. They can be [viewed](View-model-logs) per specific model deployment.
