...
description: 'Observe your deployments' metrics in real-time.'
...
You can view these metrics through the Beamlit console or by using the Beamlit CLI. For detailed instructions on how to access and interpret these metrics, refer to our API Reference (/api-reference/introduction) or CLI Reference (/cli-reference/introduction) documentation.
