...
![Screenshot 2025-05-18 at 8.53.14 PM.webp](/Agents/Query-agents/Screenshot_2025-05-18_at_8.53.14_PM.webp)
...
You can create async endpoints either from the Blaxel Console, or from your code in the `blaxel.toml` file. For more information, read the [documentation on asynchronous triggers](/Agents/Asynchronous-triggers).
