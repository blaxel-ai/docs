...
description: 'Get started with Blaxel by deploying your existing Python or TypeScript agent code as a serverless, auto-scalable API in a few minutes.'
...
- `prod` : start the agent remotely from the dist folder, the project needs to have been built before.
