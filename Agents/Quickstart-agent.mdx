...
Agent Hosting lets you bring your own agent code and deploys it as a serverless auto-scalable endpoint - no matter your development framework.
...
This creates a simple single-message agent with the Claude Agent SDK and an endpoint at `/query` to acccept requests.
...
![image](Query-agents/endpoint.png)
