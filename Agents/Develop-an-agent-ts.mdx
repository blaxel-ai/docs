...
description: 'Build, test, and run a custom TypeScript agent locally with the Blaxel SDK and CLI, including examples for Mastra, Vercel AI SDK, and LangChain.'
...
- `prod` : start the server remotely from the dist folder, the project needs to have been built before.
