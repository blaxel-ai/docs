...
## Step 3: Plug to CopilotKit your front-end

You can follow the rest of CopilotKit’s documentation on deploying CoAgents: start at [Step 4 on this tutorial](https://docs.copilotkit.ai/coagents/quickstart/langgraph). Use option “**Self hosted (FastAPI)**” for the code snippets when available.
...
The agent will be available on the following URL:
