...
description: 'Run Blaxel agent requests asynchronously with optional callbacks, allowing background tasks up to 15 minutes without keeping HTTP connections open.'
---
...
![Callback Secret](/images/agents/secret.webp)
