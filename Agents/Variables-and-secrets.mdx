...
title: 'Variables and secrets for agents'
sidebarTitle: 'Variables and secrets'

description: 'Configure environment variables and secrets for Blaxel agents to securely manage API keys, credentials, and runtime configuration values.'
