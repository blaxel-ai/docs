...
<Card title="CopilotKit" icon="c" href="/Agents/Integrate-in-apps/CopilotKit">
Turn your Blaxel agent (built with LangGraph) into an agent-native application in minutes.
</Card>

<Card title="n8n" icon="diagram-project" href="/Agents/Integrate-in-apps/n8n">
Orchestrate Blaxel agents using n8n workflows.
</Card>

<Card title="Pactory" icon="coins" href="/Integrations/Pactory">
