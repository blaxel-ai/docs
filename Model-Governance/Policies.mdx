...
Policies are used to program how and where your workloads are deployed on Blaxel. Policies can be defined as code, allowing for easy programming and customization of your [Global Inference Network](../Infrastructure/Global-Inference-Network).
...
When no policies are enforced on a type, all options for this type are considered allowed. Workloads are executed using [Global Inference Network](../Infrastructure/Global-Inference-Network)’s default optimizations.
