...
description: 'Define policies that control where workloads run on the Global Agentics Network, including location constraints, flavors, and token limits.'
...
- policies on **countries** let you define all [physical locations](/Model-Governance/Policies) inside of one or several countries at once
    - for example, execute only in the following country: *USA*
- policies on **continents** let you define all [physical locations](/Model-Governance/Policies) inside of one or several continents at once
...
- policies on **cpu** let you pass a specific list of CPU types
