...
description: 'Manage Blaxel deployments across development, staging, and production environments with environment-based governance and release strategies.'

---

![image.webp](/Model-Governance/Dev-and-prod-lifecycle/image.webp)
...
## Managing Development and Production Lifecycle with Models on Blaxel

### Introduction

Managing the development and production lifecycle of models on Blaxel involves several key stages and concepts. This guide will walk you through the process of deploying, updating, and maintaining your models across different environments.
...
4. Alternatively, use the Blaxel console for updates

### 3. Releasing to Production

To move a model from development to production:

1. Use the "releasing" feature in Blaxel
...
3. Use the Blaxel console, API, or CLI for these operations
...
- Allow overflow to Blaxel during unexpected burst traffic

### Conclusion

Effectively managing the development and production lifecycle of models on Blaxel involves understanding the platform's concepts, utilizing its deployment features, and following best practices for updates and releases. By leveraging Blaxel's serverless and distributed architecture, you can efficiently manage your AI models from development to production.