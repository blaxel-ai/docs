...
<Card title="Email Assistant" icon="envelope" href="https://github.com/blaxel-templates/template-agentmail-docbot">
A customer support agent that uses AgentMail to get its own inbox and email address — and can answer any technical question over emails. 
</Card>
