---
title: 'Connect to a Blaxel sandbox from Claude Agent SDK'
...
<Card title="Build and deploy an agent on Blaxel with Claude Agent SDK" icon="square-js" href="/Frameworks/Claude-Agent-SDK">
