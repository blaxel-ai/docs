...
Use your model deployment’s [inference endpoint](../Models/Query-a-model.md) to make an inference request. 
...
Call it via an HTTP **POST** request, authenticating yourself with a [bearer token](../Security/Access-tokens.md):
