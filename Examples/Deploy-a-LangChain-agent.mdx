...
That’s it! 🌎 🌏 🌍 Your agent is now **distributed and available** across the entire Blaxel global infrastructure! [Global Inference Network](../Models/Global-Inference-Network) significantly speeds up inferences by executing your agent’s workloads in sandboxed environments and smartly routing requests based on your policies.
