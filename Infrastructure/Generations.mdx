...
title: 'Overview of infrastructure generations'

description: 'Comparing the different generations (a.k.a. Mk) of Blaxel's infrastructure.'
...
**Mk 2 infrastructure** offers broader stability across workloads and features extensive global distribution, with more than 15 points of presence worldwide.

**Mk 3 infrastructure (coming soon!)** delivers dramatically lower cold starts, with sub-20-ms boot times for workloads. It is currently available in preview after being released in Alpha.
...
Mk 3 infrastructure leverages unikernels to run code with mission-critical low cold-starts. Mk 3’s alpha release is currently available in public preview. 
