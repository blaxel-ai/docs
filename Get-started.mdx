...
Open a terminal and login to Blaxel using this command. Find your **workspace ID in the top left corner** of Blaxel Console:
...
You can now use the [Blaxel](sdk-reference/introduction) [SDK](sdk-reference) to [develop your agent's core logic](Agents/Develop-an-agent) in `/my-agent/src/agent.py` (or `/my-agent/src/agent.ts`).
...
Complete guide for querying your AI agents on the Global Agentics Network.
</Card>
