...
Model APIs allow developers to have a centralized API that unifies credentials management and access to LLM providers. Use the Beamlit console to [create a model API](Models/Overview) and deploy the endpoint on the *Production* environment.
