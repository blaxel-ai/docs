...
description: 'Deploy your first resource on Blaxel.'
...
[Blaxel](https://app.blaxel.ai/) is a computing platform where AI builders can **deploy AI agents easily**. This tutorial demonstrates how to deploy your first resource on Blaxel.
...
<Accordion title="Create an agent application" icon="bot">
...
<Accordion title="Create a batch job" icon="chart-diagram">
<Warning>In Python, you will need to [have *uv* installed](https://docs.astral.sh/uv/getting-started/installation/); in TypeScript, you will need to [have npm installed](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) for this.</Warning>
...
<Card title="Create sandboxes" icon="box" href="/Sandboxes/Overview">
...
<Accordion title="Agent: send a test invocation" icon="bot">
...
<Accordion title="Job: execute the job locally" icon="chart-diagram">
...
<Accordion title="Agent: send an invocation request" icon="bot">
...
<Accordion title="Job: execute the job" icon="chart-diagram">
...
<Card title="Schedule and execute batch tasks" icon="chart-diagram" href="/Jobs/Overview">
