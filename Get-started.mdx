...
<Accordion title="Python: install pip">
Follow the [pip documentation](https://pip.pypa.io/en/stable/installation/) for guidance on how to install **pip**, if not already installed.
...
```bash
bl run agent <<AGENT-NAME>> --data '{"inputs":"Hello world!"}'
```
